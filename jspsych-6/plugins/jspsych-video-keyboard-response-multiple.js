...
jsPsych.plugins["video-keyboard-response-multiple"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('video-keyboard-response-multiple', 'stimulus', 'video');

  plugin.info = {
    name: 'video-keyboard-response-multiple',
    description: '',
    parameters: {
      sources: {
    ...
    if(trial.stop !== null){ 
      function video_time_update(e){
        ...
        if(currenttime >= trial.stop){
          ...
          display_element.querySelector('#jspsych-video-keyboard-response-stimulus').removeEventListener('timeupdate' , video_time_update)
          end_trial();
        }
      }
      display_element.querySelector('#jspsych-video-keyboard-response-stimulus').addEventListener('timeupdate', video_time_update)
    }
