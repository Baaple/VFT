 ...
 *
 * jspsych-instructions-hide-back-button.js
 * edited to hide back button instead of disabling it
 * Becky Gilbert, Aug 2019
 *
 */

jsPsych.plugins["instructions-hide-back-button"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'instructions-hide-back-button',
    description: '',
    parameters: {
      pages: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function show_current_page() {
      ...
      if (trial.show_clickable_nav) {
        ...
        if (trial.allow_backward && (current_page !== 0)) {
